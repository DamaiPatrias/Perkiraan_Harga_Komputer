...
?>
        ...
        <section class="content">
            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                ...
                <form action="aksi.php?sender=edit_paket" method="POST" enctype="multipart/form-data">
                  <div class="box-body">
                        <!--Processor-->
	...
	<a href="aksi.php?sender=hapus_paket&id_paket=<?php echo $idPaket; ?>" onclick="return confirm('Yakin Hapus Data?')" class="btn btn-danger"><li class="fa fa-trash-o"></li> Hapus</a>
          ...
          <div class="box">
		  <div class="box-header with-border">
                <h3 class="box-title"> <a href="index.php" class="btn btn-info"><li class="fa fa-plus"></li> Tambah</a></h3>
              <div class="box-tools pull-right">
                 </div>
            </div>
            <div class="box-body">
                    ...
                    <tbody>
                    <?php
                        $sql="SELECT  * FROM paket WHERE id_user = '$idUser' ORDER BY id_paket DESC";
                        $no=1;
                        if (!$result=  mysqli_query($config, $sql)){
                        die('Error:'.mysqli_error($config));
                        }  else {
